...
<%@page import="model.ViewPeminjamanRuang"%>
<%@page import="model.Peminjaman" %>
<%@page import="model.PeminjamanHome" %>
<%@page language="java" %>
<%@page contentType="text/html" pageEncoding="UTF-8"%>

<%
    PeminjamanHome ph = new PeminjamanHome();
    ViewPeminjamanRuang[] daftarPeminjaman = ph.getDaftarPeminjaman();
%>
<html>
                            ...
                            <div class="col-lg-6 col-7">
                                ...
                                <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                                    <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Tabel Logbook</li>
                                    </ol>
                                </nav>
                            </div>
                            <div class="col-lg-6 col-5 text-right">
                                <a href="inputLogbook.jsp" class="btn btn-sm btn-neutral"><b>+</b></a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col">
                        <div class="card">
                            ...
                            <div class="card-header border-0">
                                <h3 class="mb-0">Logbook Peminjaman Ruang</h3><br>
                            </div>
                            <!-- Light table -->
                            <div class="table-responsive">
                                <table class="table align-items-center table-flush">
                                    ...
                                    <tbody class="list">
                                        ...
                                        <tr>
                                            <th scope="row"><%=(i + 1)%></th>
                                            <td><%=daftarPeminjaman[i].getId_peminjaman()%></td>
                                            <td><%=daftarPeminjaman[i].getNama_peminjam()%></td>
                                            <td>R.<%=daftarPeminjaman[i].getNomor_ruangan()%> - <%=daftarPeminjaman[i].getNama_ruangan()%></td>
                                            <td><%=daftarPeminjaman[i].getWaktu_dipinjam()%></td>
                                            <td><%=daftarPeminjaman[i].getWaktu_dikembalikan()%></td>
                                            <td><%=daftarPeminjaman[i].getAlasan_peminjaman()%></td>
                                        </tr>
                                        <%}%>
                                    </tbody>
                                </table>
